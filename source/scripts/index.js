...
class RangeSlider extends HTMLElement {
  ...
  initMinMaxElements() {
      ...
      /* тут под себя этот код переделал, чтобы значения отображались не в окошках над собачками а в инпутах*/
      this.minOutput = document.querySelector(".aside__price-limit--min");
      this.maxOutput = document.querySelector(".aside__price-limit--max");
  }
